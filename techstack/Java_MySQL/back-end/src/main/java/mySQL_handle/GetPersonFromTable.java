...
public class GetPersonFromTable {
    ...
    public GetPersonFromTable(Connection connection) {
    ...
    public int getAgeByName(String name, String tablename) {
        // Create the SQL query string to fetch the age of the person based on their
