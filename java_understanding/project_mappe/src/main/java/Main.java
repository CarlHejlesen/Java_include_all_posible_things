...
public class Main {
    public static void main(String[] args) {// Her eksikvere vi vores kode fra. ALtså her starter vores kode.
        ...
        // Forsøg på at ændre obj1's instanceID ville resultere i en kompileringsfejl, for eksempel:
        // obj1.instanceID = "ID-789"; // Dette ville ikke kompilere.
        
        // Output af instanceCount ved brug af static metode
        System.out.println("Antal instanser skabt: " + static_and_final.getInstanceCount()); // Output: Antal instanser skabt: 2
